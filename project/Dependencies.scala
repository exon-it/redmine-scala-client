...
object Dependencies {
  ...
  val play25Ws         : ModuleID = "com.typesafe.play" %% "play-ws" % "2.5.15"
  val playWsStandalone : ModuleID = "com.typesafe.play" %% "play-ahc-ws-standalone" % "1.0.0"
  val json4sCore       : ModuleID = "org.json4s" %% "json4s-core" % "3.5.2"
  val json4sJackson    : ModuleID = "org.json4s" %% "json4s-jackson" % "3.5.2"
