...
import Implicits._
import by.exonit.redmine.client.playws.standalone.PlayWSStandaloneWebClient.{RequestInterpreter, RequestState, ResponseInterpreter, StreamingResponseInterpreter}
