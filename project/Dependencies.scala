...
object Dependencies {
  ...
  val jodaConvert      : ModuleID = "org.joda" % "joda-convert" % "2.1.1"
  val play25Ws         : ModuleID = "com.typesafe.play" %% "play-ws" % "2.5.19"
  val play26Ws         : ModuleID = "com.typesafe.play" %% "play-ahc-ws" % "2.6.18"
  val play27Ws         : ModuleID = "com.typesafe.play" %% "play-ahc-ws" % "2.7.0-M3"
  val playWsStandalone : ModuleID = "com.typesafe.play" %% "play-ahc-ws-standalone" % "1.1.10"
  val playWsStandalone2: ModuleID = "com.typesafe.play" %% "play-ahc-ws-standalone" % "2.0.0-M2"
  val json4sCore       : ModuleID = "org.json4s" %% "json4s-core" % "3.6.1"
  val json4sJackson    : ModuleID = "org.json4s" %% "json4s-jackson" % "3.6.1"
  ...
  val catsFree         : ModuleID = "org.typelevel" %% "cats-free" % "1.3.1"
